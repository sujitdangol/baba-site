...
<!-- Mirrored from portotheme.com/html/porto/demo-8/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Mar 2019 09:05:23 GMT -->
<head>
    <meta charset="UTF-8">
                            ...
                            <div class="dropdown-menu" >
                                <div class="dropdownmenu-wrapper">
                                    ...
                                    <div class="dropdown-cart-action">
                                        <a href="./checkout-shipping.php" class="btn btn-block">Checkout</a>
                                    </div><!-- End .dropdown-cart-total -->
                                </div><!-- End .dropdownmenu-wrapper -->
                            </div><!-- End .dropdown-menu -->
                        </div><!-- End .dropdown -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="./category.php">4 Columns Products <span class="tip tip-new">New</span></a></li>
